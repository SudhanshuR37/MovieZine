...
function getCoord(e) {
    ...
    TweenMax.to(eyeL, 1, { x: -eyeLX, y: -eyeLY, ease: ExpoScaleEase.easeOut });
    TweenMax.to(eyeR, 1, { x: -eyeRX, y: -eyeRY, ease: ExpoScaleEase.easeOut });
    TweenMax.to(nose, 1, { x: -noseX, y: -noseY, rotation: mouthR, transformOrigin: "center center", ease: ExpoScaleEase.easeOut });
    TweenMax.to(mouth, 1, { x: -mouthX, y: -mouthY, rotation: mouthR, transformOrigin: "center center", ease: ExpoScaleEase.easeOut });
    TweenMax.to(chin, 1, { x: -chinX, y: -chinY, scaleY: chinS, ease: ExpoScaleEase.easeOut });
    TweenMax.to(face, 1, { x: -faceX, y: -faceY, skewX: -faceSkew, transformOrigin: "center top", ease: ExpoScaleEase.easeOut });
    TweenMax.to(eyebrow, 1, { x: -faceX, y: -faceY, skewX: -eyebrowSkew, transformOrigin: "center top", ease: ExpoScaleEase.easeOut });
    TweenMax.to(outerEarL, 1, { x: outerEarX, y: -outerEarY, ease: ExpoScaleEase.easeOut });
    TweenMax.to(outerEarR, 1, { x: outerEarX, y: outerEarY, ease: ExpoScaleEase.easeOut });
    TweenMax.to(earHairL, 1, { x: -outerEarX, y: -outerEarY, ease: ExpoScaleEase.easeOut });
    TweenMax.to(earHairR, 1, { x: -outerEarX, y: outerEarY, ease: ExpoScaleEase.easeOut });
    TweenMax.to(hair, 1, { x: hairX, scaleY: hairS, transformOrigin: "center bottom", ease: ExpoScaleEase.easeOut });
...
function onEmailInput(e) {
    ...
    if (curEmailIndex > 0) {
        if (mouthStatus == "small") {
            mouthStatus = "medium";
            TweenMax.to([mouthBG, mouthOutline, mouthMaskPath], 1, { morphSVG: mouthMediumBG, shapeIndex: 8, ease: ExpoScaleEase.easeOut });
            TweenMax.to(tooth, 1, { x: 0, y: 0, ease: ExpoScaleEase.easeOut });
            TweenMax.to(tongue, 1, { x: 0, y: 1, ease: ExpoScaleEase.easeOut });
            TweenMax.to([eyeL, eyeR], 1, { scaleX: .85, scaleY: .85, ease: ExpoScaleEase.easeOut });
        }
        if (value.includes("@")) {
            mouthStatus = "large";
            TweenMax.to([mouthBG, mouthOutline, mouthMaskPath], 1, { morphSVG: mouthLargeBG, ease: ExpoScaleEase.easeOut });
            TweenMax.to(tooth, 1, { x: 3, y: -2, ease: ExpoScaleEase.easeOut });
            TweenMax.to(tongue, 1, { y: 2, ease: ExpoScaleEase.easeOut });
            TweenMax.to([eyeL, eyeR], 1, { scaleX: .65, scaleY: .65, ease: ExpoScaleEase.easeOut, transformOrigin: "center center" });
        } else {
            mouthStatus = "medium";
            TweenMax.to([mouthBG, mouthOutline, mouthMaskPath], 1, { morphSVG: mouthMediumBG, ease: ExpoScaleEase.easeOut });
            TweenMax.to(tooth, 1, { x: 0, y: 0, ease: ExpoScaleEase.easeOut });
            TweenMax.to(tongue, 1, { x: 0, y: 1, ease: ExpoScaleEase.easeOut });
            TweenMax.to([eyeL, eyeR], 1, { scaleX: .85, scaleY: .85, ease: ExpoScaleEase.easeOut });
        }
        ...
        mouthStatus = "small";
        TweenMax.to([mouthBG, mouthOutline, mouthMaskPath], 1, { morphSVG: mouthSmallBG, shapeIndex: 9, ease: ExpoScaleEase.easeOut });
        TweenMax.to(tooth, 1, { x: 0, y: 0, ease: ExpoScaleEase.easeOut });
        TweenMax.to(tongue, 1, { y: 0, ease: ExpoScaleEase.easeOut });
        TweenMax.to([eyeL, eyeR], 1, { scaleX: 1, scaleY: 1, ease: ExpoScaleEase.easeOut });
    }
}
...
function resetFace() {
    TweenMax.to([eyeL, eyeR], 1, { x: 0, y: 0, ease: ExpoScaleEase.easeOut });
    TweenMax.to(nose, 1, { x: 0, y: 0, scaleX: 1, scaleY: 1, ease: ExpoScaleEase.easeOut });
    TweenMax.to(mouth, 1, { x: 0, y: 0, rotation: 0, ease: ExpoScaleEase.easeOut });
    TweenMax.to(chin, 1, { x: 0, y: 0, scaleY: 1, ease: ExpoScaleEase.easeOut });
    TweenMax.to([face, eyebrow], 1, { x: 0, y: 0, skewX: 0, ease: ExpoScaleEase.easeOut });
    TweenMax.to([outerEarL, outerEarR, earHairL, earHairR, hair], 1, { x: 0, y: 0, scaleY: 1, ease: ExpoScaleEase.easeOut });
}
